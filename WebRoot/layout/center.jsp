		...
		if (centerTabs.tabs('exists', nodes[0])) {
			...
			/*if (node.attributes.url && node.attributes.url.length > 0) {
				...
				centerTabs.tabs('add', {
					...
					content : "<iframe src="+nodes[2]+" frameborder=\"0\" style=\"border:0;width:100%;height:100%;\"></iframe>",
					tools : [ {
						iconCls : 'icon-mini-refresh',
						handler : function() {
							refreshTab(nodes[0]);
...
<div id="theme" class="easyui-menu" style="width:120px;display: none" data-options="border:false">  
    <div id="default" data-options="iconCls:'icon-color'">default</div>  
    <div id="black" data-options="iconCls:'icon-color'">black</div> 
    <div id="bootstrap" data-options="iconCls:'icon-color'">bootstrap</div>  
    <!--  
    ...
    <div id="ui-cupertino" data-options="iconCls:'icon-save'">ui-cupertino</div> 
    <div id="ui-sunny" data-options="iconCls:'icon-save'">ui-sunny</div> 
    -->
</div>