			...
			<fieldset>
				...
				<input name="state" id="state"  type="hidden"/>
				 <table>
					 <tr>
					    <th>程式名称</th>
						<td><input name="name" id="name" placeholder="请输入程式名称" class="textinput easyui-validatebox" type="text"/></td>
						<th>父程式名称</th>
						<td><input name="pid"  class="textinput" id="pid" type="text"/><input name="pname" id="pname"  type="hidden"/></td>
						
					 </tr>
					 <tr>
					    <th>排序编码</th>
						<td><input name="sort" id="sort" type="text" class="textinput easyui-validatebox" required="required"/></td>
						<th>程式图标</th>
						<td><input id="iconCls" name="iconCls" type="text"/></td>
					 </tr>
					  <tr>
					    <th>程式路径</th>
						<td><input id="url" name="url" type="text" class="textinput easyui-validatebox" required="required"/></td>
						<th>程式编码</th>
						<td><input id="myid" name="myid" type="text" class="textinput easyui-validatebox" required="required"/></td>
					 </tr>
					 <tr>
						<th>程式类型</th>
						<td>
					 ...
					 <tr>
						<th>描述</th>
						<td colspan="3"><textarea class="textinput" name="description"  style="width: 435px;height: 100px;"></textarea></td>
					</tr>
				 </table>
			</fieldset>
		</form>
