  ...
  <body class="easyui-layout" data-options="fit:true">
  	<div data-options="region:'north',border:false" title="" style="height:auto;overflow:hidden;">
			<div class="well well-small datagrid-toolbar" style="margin-left: 0px;margin-top: 2px;margin-right: 0px;margin-bottom: 2px;">
				...
				<span>在此你可以对<span class="label-info"><strong>商户结算</strong></span>进行月报的查询!</span>
			</div>
	</div>
			...
			<div id="tb" style="padding:2px 0">
				<table cellpadding="0" cellspacing="0" style="width:100%" class="tablegrid">
					<tr>
						...
						<td class="tableright">
							<input style="width:140px;" id="month" type="text" name="month" class="Wdate textinput" onclick="WdatePicker({dateFmt:'yyyy-MM'})"/>
						</td>
