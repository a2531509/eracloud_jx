	...
	<script type="text/javascript">
		...
		function checkRowsOpenDlg(){
			...
			if (rows.length>0) {
				...
				$.ajax({
					url:"merchantSettle/merchantSettleAction!saveSettlementAudit.action?stlSumNo="+stlSumNo,
  ...
  <body class="easyui-layout" data-options="fit:true">
  	<div data-options="region:'north',border:false" title="" style="height:auto;overflow:hidden;">
			<div class="well well-small datagrid-toolbar" style="margin-left: 0px;margin-top: 2px;margin-right: 0px;margin-bottom: 2px;">
				...
				<span>在此你可以对<span class="label-info"><strong>商户结算</strong></span>进行审核操作!</span>
			</div>
	</div>
				...
				<table cellpadding="0" cellspacing="0" style="width:100%" class="tablegrid">
					...
					<tr>
						...
						<td class="tableright" colspan="6">
							...
							<shiro:hasPermission name="rollBackSettle">
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-back"  plain="false" onclick="callBackSettle();">回退</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="chkMerSettleInfo">
