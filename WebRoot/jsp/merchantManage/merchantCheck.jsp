	...
	<script type="text/javascript">
		...
		function checkinfo(state){
			...
			if(row){
				...
				if(stateName!='2'){
					$.messager.alert("系统消息","您选择商户状态为！【"+string+"】,不能审核","error");
					return;
				}
	...
	<div data-options="region:'center',split:false,border:false" style="height:auto;overflow:hidden;">
			<div id="tb" style="padding:2px 0">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td style="padding-left:2px">商户编码：</td>
						<td style="padding-left:2px"><input id="merchantId" type="text" class="textinput" name="merchantId"  style="width:174px;cursor:pointer;"  /></td>
						<td style="padding-left:2px">商户名称：</td>
						<td style="padding-left:2px"><input id="merchantName" type="text" class="textinput" name="merchantName"  style="width:174px;cursor:pointer;"  /></td>
						<td style="padding-left:2px">商户状态：</td>
						<td style="padding-left:2px"><select id="merchantState" class="easyui-combobox easyui-validatebox" name="merchantState" style="width:174px;" data-options="panelHeight: 'auto'"  validType="selectValueRequired['#smerchantState']">
