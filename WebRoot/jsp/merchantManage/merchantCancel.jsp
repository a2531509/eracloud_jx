			 ...
			 $('#merchantId').combobox({
                 ...
                 onChange: function (newValue, oldValue) {
                     if (newValue != null) {
                         ...
                         var urlStr = "merchantManage/merchantManageAction!getBizName.action?objStr=" + thisKey;
                         $("#merchantId").combobox("reload", urlStr);
                     }
                 }
  ...
  <div class="easyui-layout" data-options="fit:true" >
	...
	<div data-options="region:'center',split:false,border:false" style="height:auto;overflow:hidden;">
			<div id="tb" style="padding:2px 0">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="padding-left:2px"><input id="merchantId" type="text" class="easyui-combobox  easyui-validatebox" name="merchantId"  style="width:174px;cursor:pointer;"  /></td>
			...
			<div id="mm1" style="width:50px;display: none;">
			     <div data-options="iconCls:'icon-ok'" onclick="checkinfo('1')">注销</div>
		     </div>
