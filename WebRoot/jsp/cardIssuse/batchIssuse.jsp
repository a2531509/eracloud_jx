	...
	$(function() {
		...
		$grid = createDataGrid({
			...
			columns:[[
				...
				{field:"TASK_STATE",title:"任务状态",sortable:true,width:parseInt($(this).width() * 0.08)},
				...
				{field:"TASK_DATE",title:"任务时间",sortable:true,width:parseInt($(this).width() * 0.14)},
...
<n:initpage title="规模申领任务进行批量发放操作！">
	<n:center>
		<div id="tb" >
			<form id="searchConts">
