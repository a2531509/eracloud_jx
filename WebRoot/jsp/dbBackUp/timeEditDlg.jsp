			...
			<fieldset>
				...
				<p>
				 ...
				 <table>
					 <tr>
					    <th>小时(H)</th>
						<td><input name="scheduleHour" id="scheduleHour"  class="textinput easyui-numberbox" data-options="min:1,max:24,required:true" type="text"/></td>
					    <th>分钟(M)</th>
						<td><input name="scheduleMinute" id="scheduleMinute"  class="textinput easyui-numberbox" data-options="min:1,max:59,required:true" type="text"/></td>
					 </tr>
				 </table>
			</fieldset>
		</form>
