	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#fileType").combobox({
			    ...
			    textField:"codeName",
			    panelHeight:'auto',
			    data:[{codeValue:'',codeName:"请选择"},{codeValue:'01',codeName:"充值"},{codeValue:'02',codeName:"消费"},{codeValue:'03',codeName:"圈提"},{codeValue:'04',codeName:"圈付"}]
			});
			//是否有明细
			...
			$dg = $("#dg");
			$grid=$dg.datagrid({
				url:"corpCheckAccount/corpCheckAccountAction!findAllCheckBill.action",
				pagination:true,
				rownumbers:true,
				border:false,
				striped:true,
				...
				frozenColumns:[[
					...
					{field:'FILE_TYPE',title:'对账类型',sortable:true,width:parseInt($(this).width()*0.06)},
		...
		function viewchecklist(){
			...
			if(row){
				$.modalDialog({
					...
					closable:false,
					maximizable:false,
					href:"jsp/clrsettlemanage/corpcheckbilLlistnew.jsp" ,
					onLoad:function(){
						if(row){
