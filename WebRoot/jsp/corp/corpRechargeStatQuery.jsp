...
<script type="text/javascript">
	...
	$(function(){
		...
		$grid = createDataGrid({
			id:"dg",
			url:"statistical/statisticalAnalysisAction!corpRechargeQuery.action",
			fit:true,
			pagination:true,
			rownumbers:true,
			border:false,
			...
			columns:[[
				...
				{field:"CR_CUSTOMER_ID",title:"单位编号",sortable:true,width:parseInt($(this).width() * 0.12)},
				{field:"CORP_NAME",title:"单位名称",sortable:true,width:parseInt($(this).width() * 0.12)},
...
<n:initpage title="单位充值情况进行查询操作！">
	<n:center>
		<div id="tb">
  		...
  		<table id="dg" title="单位充值信息"></table>
	</n:center>
</n:initpage>