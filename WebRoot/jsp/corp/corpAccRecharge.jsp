...
<script type="text/javascript">
	...
	function corpAccRecharge(){
		...
		$.modalDialog({
			title:"单位账户信息",width:640,height:250,
			iconCls:"icon-rechgCard",maximizable:true,
			href:"corpManager/corpManagerAction!toCorpCashAccRecharge.action?customerId=" + selection[0].CUSTOMER_ID,	
			buttons:[ 
		        {
	...
	<div data-options="region:'north',border:false"
		...
		<div class="well well-small datagrid-toolbar" style="margin: 2px 0">
			<span class="badge">提示</span> <span>在此你可以对<span
				class="label-info"><strong>开户成功的单位</strong></span>进行<span
				class="label-info"><strong>充值操作</strong></span></span>
		</div>
	</div>
			...
			<table class="tablegrid" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td class="tableright" colspan="2" style="padding-left: 15px;"><a
						...
						href="javascript:void(0);" class="easyui-linkbutton"
						iconCls="icon-rechgCard" onclick="corpAccRecharge()">单位账户充值</a></td>
				</tr>
			</table>
		</div>
