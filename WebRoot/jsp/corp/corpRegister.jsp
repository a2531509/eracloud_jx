	...
	function autoCom(){
        ...
        $("#customerId").autocomplete({
            source: function(request,response){
                $.post('corpManager/corpManagerAction!initAutoComplete.action',{"customerId":$("#customerId").val(),jugeCorp:true},function(data){
	...
	<div data-options="region:'north',border:false"
		...
		<div class="well well-small datagrid-toolbar" style="margin: 2px 0">
			<span class="badge">提示</span> <span>在此你可以对<span
				...
				class="label-info"><strong>新增/编辑</strong></span></span>
		</div>
	</div>
