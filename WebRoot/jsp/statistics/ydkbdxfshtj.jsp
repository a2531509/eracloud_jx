...
<script type="text/javascript">
    ...
    $(function(){
        ...
        createLocalDataSelect({
            ...
            data:[
                {value:"",text:"请选择"},
                {value:"041010010010001",text:"嘉兴市公共交通公司"},
                {value:"041010010010002",text:"嘉兴市国鸿汽车运输有限公司公交分公司"},
                {value:"041010010010011",text:"桐乡市公共交通IC卡服务中心"},
                {value:"100102100101050",text:"平湖市开元运务有限公司"},
                {value:"100102100101010",text:"嘉善县城市公交有限公司"},
                {value:"100102100101013",text:"海盐鸿远公共交通有限公司"},
                {value:"100102100101030",text:"海宁市大元公交有限责任公司"}
            ],
            value:""
        });
        ...
        $grid = createDataGrid({
            id:"dg",
            url:"unionManage/UnionManageAction!queryYdkBdConsumeShStat.action",
            pagination:true,
            rownumbers:true,
            border:false,
            striped:true,
            ...
            frozenColumns:[
                [
                    ...
                    {colspan:2,title:"商户信息",sortable:true,align:"center"},
                    {field:"SETTLE_DATE",rowspan:3,title:"结算日期",sortable:true,align:"center"},
                    {title:"全国",colspan:8,sortable:true}
                ],
                [
                    {field:"ACPT_ID",rowspan:2,title:"商户名称",sortable:true},
                    {field:"MERCHANT_NAME",rowspan:2,title:"商户名称",sortable:true},
                    {title:"结算数据",colspan:6,sortable:true},
                    {title:"小计",colspan:2,sortable:true}
                ],
                [
                    {field:"QGZCTOTNUM",title:"正常笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"QGZCTOTAMT",title:"正常金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
                    {field:"QGJFTOTNUM",title:"拒付笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"QGJFTOTAMT",title:"拒付金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
                    {field:"QGTZTOTNUM",title:"调整笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"QGTZTOTAMT",title:"调整金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
                    {field:"QGTZTOTAM1",title:"结算笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return (Number(row.QGZCTOTNUM) + Number(row.QGTZTOTNUM));
                    }},
                    {field:"QGTZTOTAM2",title:"结算金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index) {
            ...
            columns:[
                ...
                [
                    {field:"SHZCTOTNUM",title:"正常笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"SHZCTOTAMT",title:"正常金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
                    {field:"SHJFTOTNUM",title:"拒付笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"SHJFTOTAMT",title:"拒付金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
                    {field:"SHTZTOTNUM",title:"调整笔数",align:"center",sortable:false,width:parseInt($(this).width() * 0.05)},
                    {field:"SHTZTOTAMT",title:"调整金额",align:"center",sortable:false,width:parseInt($(this).width() * 0.05),formatter:function(value,row,index){
                        return $.foramtMoney(value);
                    }},
            ...
            onLoadSuccess:function(data){
                ...
                $grid.datagrid("autoMergeCells",["ACPT_ID","MERCHANT_NAME","SETTLE_DATE"]);
                initCal();
                updateFooter();
            },
    ...
    function startDetect(){
        commonDwr.isDownloadComplete("queryYdkBdConsumeShStatExport",function(data){
    ...
    function exportFile(){
        ...
        jConfirm("您确定要进行导出吗？",function(){
            ...
            $("#searchConts").get(0).action = "unionManage/UnionManageAction!queryYdkBdConsumeShStatExport.action";
            $("#searchConts").get(0).submit();
            startCycle();
        });
    }
</script>
<n:initpage title="互联互通异地卡在本地各商户消费情况进行结算统计！">
    <n:center>
        <div id="tb">
            <form id="searchConts">
                <table class="tablegrid">
                    <tr>
                        ...
                        <td class="tableright"><input id="bizId" name="bizId" type="text" class="textinput" maxlength="15"/></td>
