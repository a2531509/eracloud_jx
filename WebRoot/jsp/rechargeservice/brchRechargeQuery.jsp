	...
	$(function() {
		...
		$grid = createDataGrid({
			...
			frozenColumns:[[
				...
				{field:"ACPT_ID",title:"网点编号",sortable:true},
				{field:"FULL_NAME",title:"网点名称",sortable:true},
			]],
			columns:[[
...
<n:initpage title="网点充值情况进行查询！">
	<n:center>
		<div id="tb">
			<form id="searchConts">
				<input type="hidden" name="acptType" value="1"/>
  		...
  		<table id="dg" title="网点充值详细信息"></table>
