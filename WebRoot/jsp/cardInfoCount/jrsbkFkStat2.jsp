...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $grid = createDataGrid({
            id:"dg",
            url:"statistical/statisticalAnalysisAction!jrsbkFkStat.action",
            pagination:true,
            rownumbers:true,
            border:false,
            striped:true,
            ...
            <form id="searchConts">
                <table class="tablegrid">
                    ...
                    <tr>
                        ...
                        <td class="tableright"><input id="beginTime" name="beginTime" type="text" class="Wdate textinput" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'2018-02-01'})"/></td>
