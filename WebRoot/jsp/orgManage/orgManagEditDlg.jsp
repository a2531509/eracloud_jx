			...
			<fieldset>
				...
				<input name="orgState" id="orgState"  type="hidden"/>
				 <table>
					 <tr>
					 	<th>机构编码</th>
						<td><input name="orgId" id="orgId" type="text"  class="textinput easyui-validatebox" data-options="required:true" readonly="readonly"/></td>
					    <th>机构名称</th>
						<td><input name="orgName" id="orgName" placeholder="请输入机构名称" class="textinput easyui-validatebox" type="text" data-options="required:true" readonly="readonly"/></td>
					 </tr>
					 <tr>
					    <th>机构类型</th>
						<td><select id="orgType" name="orgType" class="easyui-combobox easyui-validatebox"  style="width:174px;"  validType="selectValueRequired['#orgType']" readonly="readonly">
						...
						<th>机构级别</th>
						<td><select id="orgClass" class="easyui-combobox easyui-validatebox" name="orgClass" style="width:174px;"  validType="selectValueRequired['#orgClass']" readonly="readonly" >
					  ...
					  <tr>
						...
						<th>银行账号</th>
						<td><input id=accNo name="accNo" type="text" class="textinput easyui-validatebox" data-options="required:true"/></td>
					 </tr>
					 <tr>
						<th>联系人</th>
