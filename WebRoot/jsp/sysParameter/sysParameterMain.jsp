      ...
      <div data-options="region:'center',border : false">
  		<div class="well well-small datagrid-toolbar" style="margin-left: 0px;margin-top: 2px;margin-right: 0px;margin-bottom: 2px;">
			<span class="badge">提示</span> <span> 在此你可以对<span
					class="label-info"><strong>系统参数</strong></span>进行是设置和编辑!
			</span>
		</div>
				...
				<tr>
					<td style="padding-left:2px">
						<shiro:hasPermission name="parEndEdit">
							<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-end" plain="false" onclick="endEdit();">结束编辑</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="parDel">
							<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" plain="false" onclick="removeRows();">删除</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="parSave">
							<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-save" plain="false" onclick="saveRows();">保存修改</a>
						</shiro:hasPermission>
					</td>
					<!--  <td style="padding-left:2px">
					...
					<td style="padding-left:2px">
						<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="false" onclick="tbsCompanySearch();">高级查询</a>
					</td>-->
				</tr>
			</table>
		</div>
