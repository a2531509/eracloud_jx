...
<script type="text/javascript">
	...
	$(function(){
		...
		$grid = createDataGrid({
			id:"dg",
			url:"sysReportQuery/sysReportQueryAction!coOrgCardServiceIncomeStat.action",
			pagination:true,
			rownumbers:true,
			border:false,
			striped:true,
			...
			frozenColumns:[
			    [
					...
					{field:"BANK_ID", title:"银行编号", rowspan:2},
					{field:"BANK_NAME", title:"银行名称", rowspan:2},
	...
	function exportFile(){
		...
		jConfirm("您确定要进行导出吗？",function(){
			...
			$("#searchConts").get(0).action = "sysReportQuery/sysReportQueryAction!cardServiceIncomeExport.action";
			...
			<form id="searchConts">
				<table class="tablegrid">
					<tr>
						...
						<td class="tableright"><input id="bankId" name="rec.coOrgId" type="text" class="textinput"/></td>
						...
						<td class="tableright" style="padding-left: 20px">
