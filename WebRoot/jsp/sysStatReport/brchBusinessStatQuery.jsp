  ...
  <head>
	...
	$(function() {
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"KPHS_NUM", title:"卡片回收", width:"80px", align:"center", formatter:buildNum}
			]],
	...
	function query(){
		...
		var param = {
				...
				cascadeBrch:$("#cascadeBrch").prop("checked")
			};
	...
	function exportToExcel(){
		var param = "brch_Id=" + $("#branchId").combobox("getValue")
				+ "&startDate=" + $("#startDate").val()
				+ "&endDate=" + $("#endDate").val()
				+ "&queryType=1&cascadeBrch=" + $("#cascadeBrch").prop("checked")
				+ "&rows=1000";
...
<body class="easyui-layout" data-options="fit:true">
  	<div data-options="region:'north',border:false" title="" style="height:auto;overflow:hidden;">
			<div class="well well-small datagrid-toolbar" style="margin-left:0px;margin-right:0px;margin-top: 2px;margin-bottom: 2px;">
				...
				<span>在此你可以对<span class="label-info"><strong>网点柜面业务统计信息</strong></span>进行查询，导出操作!</span>
			</div>
	</div>
	<div data-options="region:'center',split:false,border:true" style="border-left:none;border-bottom:none;height:auto;overflow:hidden;background-color:rgb(245,245,245);">
			<div id="tb" style="padding:2px 0">
				<table cellpadding="0" cellspacing="0" class="tablegrid" style="width:100%">
					<tr>
						...
						<td class="tableright"><input id="dealCode" type="text" name="dealCode" class="textinput" /></td> -->
			...
			<table id="dg" title="网点柜面业务统计"></table>
	  </div>
