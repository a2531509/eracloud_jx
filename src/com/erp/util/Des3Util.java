...
public class Des3Util {
	 ...
	 */
	public static String encrypt_3des(String data, String firstKey, String secondKey,String thirdKey) {
	 ...
	 */
	public static String decrypt_3des(String data, String firstKey, String secondKey,String thirdKey) {
		int leng = data.length();
		String decStr = "";
		List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
		int firstLength = 0, secondLength = 0, thirdLength = 0;
	...
	public static void main(String[] args) {
		System.out.println(encrypt_3des("123456","erp2","",""));
