...
public class Base64 {
	...
	public static String encodeBytesForMail(byte[] source, String encode) {
		String tmp = encodeBytes(source, 0, source.length, DONT_BREAK_LINES);
		return "=?" + encode + "?b?" + tmp + "?=";
	} // end encodeBytes
